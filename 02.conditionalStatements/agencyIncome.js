function income(input) {
    ...
    let netTicketPriceKids = netTicketPriceAdults * 0.30
    ...
    let totalTicketsPrice = (ticketCountKids * totalKidsPrice) + (ticketCountAdults * totalAdultsPrice)

    let profit = totalTicketsPrice * 0.20
   

    console.log(`The profit of your agency from ${avioAgency} tickets is ${profit.toFixed(2)} lv.`)
